    ...
    <main className="bg-slate-50 dark:bg-slate-900 transition-colors">
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <h1 className="mt-6 text-4xl sm:text-6xl font-extrabold text-primary dark:text-white">École de Langues <span className="text-accent">BestTravel</span></h1>
          ...
          <div className="mt-8 flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Link to="/procedures" className="px-8 py-4 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl font-bold text-lg hover:bg-slate-100 dark:hover:bg-slate-700 dark:text-white transition-all">
              Voir les procédures
            </Link>
          </div>
        </div>
